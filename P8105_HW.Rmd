...
The _Penguins_ dataset has `r nrow(penguins)` observations represented by rows and `r ncol(penguins)` variables, which are displayed in the columns. An average penguin in this dataset has a flipper length that is 200.92mm. Their bills are, on average, 
